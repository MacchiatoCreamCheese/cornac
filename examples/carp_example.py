...
# ============================================================================
"""Example for CARP (A Capsule Network for Recommendation) on Amazon Digital Music."""
...
# (e.g. GoogleNews-vectors-negative300.bin). If left as None, embeddings are
# initialized randomly.
model = cornac.models.CARP(
    embedding_size=300,
